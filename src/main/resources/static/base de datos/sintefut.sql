...
--
-- Host: 127.0.0.1:3366
-- Generation Time: Nov 24, 2023 at 03:17 PM
...
CREATE TABLE `administrador_centro` (
  `Id_Administrador_Centro` int(10) NOT NULL,
  `Identificación` int(20) NOT NULL,
...
INSERT INTO `administrador_centro` (`Id_Administrador_Centro`, `Identificación`, `Primer_Apellido`, `Segundo_Apellido`, `Primer_nombre`, `Segundo_Nombre`, `Email`, `fecha_nacimiento`, `id`, `identificacion`) VALUES
(0, 2020, 'Torres', 'Cabrales', 'Alex', 'David', 'aDavid@gmail.com', '1998-03-17 00:00:00.000000', 0, 0);
...
ALTER TABLE `administrador_centro`
  ADD PRIMARY KEY (`Id_Administrador_Centro`);
